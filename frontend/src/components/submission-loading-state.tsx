  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[960px] px-4 flex flex-col items-center justify-center gap-12">
        {/* Glassmorphic Card */}
        <div className="w-full max-w-[460px] bg-card/70 dark:bg-secondary/60 backdrop-blur-2xl border border-white/60/50 shadow-lg rounded-3xl p-8 md:p-10 flex flex-col items-center text-center transition-all">
          {/* Circular Loader Animation */}
          <div className="relative mb-8 size-24 flex items-center justify-center">
            {/* Static Background Ring */}
            <svg className="absolute inset-0 size-full text-slate-200 dark:text-primary/50" viewBox="0 0 100 100">
          ...
          <div className="space-y-3 mb-8">
            ...
            <p className="text-muted-foreground text-sm font-normal leading-relaxed px-2">
          ...
          <div className="w-full flex flex-col gap-2.5">
            ...
            <div className="h-1.5 w-full bg-secondary rounded-full overflow-hidden border border-border/50 dark:border-slate-600/20">
              <div
                className="h-full bg-primary rounded-full transition-all duration-1000 ease-out relative overflow-hidden"
                style={{ width: `${progress}%` }}
              >
                <div className="absolute inset-0 bg-card/20 w-full h-full animate-pulse"></div>
              </div>
            </div>
          </div>
        ...
        <div className="opacity-40 hover:opacity-100 transition-opacity duration-300">
          <div className="flex items-center gap-2.5 text-primary group cursor-default">
